...
# 1. ATS Score (0-100)
# 2. Strengths (4-5 bullet points)
# 3. Improvements (4-5 bullet points)
...
#     prompt = f"""
# You are an expert ATS System + Senior Hiring Manager with 15+ years of recruitment experience across top companies.
# Evaluate the resume with the same rigor used in real interviews and automated screening systems.

# Your analysis must consider:
# - Keyword relevance to general industry standards
...
# - Missing competencies that weaken the candidate’s profile
...
# - Each improvement must be ONE line only.
# - Improvements must clearly mention what to fix, what is missing, and what to add.
