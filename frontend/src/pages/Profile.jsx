...
// export default function Profile({ handleNavigation }) {
...
//   // Load from localStorage first, then sync with user context - only on mount
//   useEffect(() => {
//     const savedProfile = localStorage.getItem("profile");
//     console.log("Profile component mounted. Saved profile:", savedProfile);
...
//       }
//     } else if (user) {
//       console.log("No saved profile, loading from user context:", user);
//       setFormData({
//         name: user.name || "",
//         email: user.email || "",
//         location: "",
...
//       console.log("Verified localStorage set:", localStorage.getItem("profile"));

//       setMessage("Profile saved successfully!");
//       setTimeout(() => handleNavigation?.("overview"), 800);
//     } catch (err) {
//       console.error(err);
