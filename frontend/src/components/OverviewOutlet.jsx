...
/**
 * OverviewOutlet.jsx
 * - Clean, componentized layout for Overview page
 * - Added clear SVG icons for: Overview, Resume Analysis, Career Roadmap,
 *   Interview Preparation, Skills Gap
 * - StatCard, QuickActionItem, CareerTip helper components included
 */
...
// Quick action item row
const QuickActionItem = ({ text, IconComponent, inactiveColor }) => (
  <div className="flex justify-between items-center p-4 rounded-lg cursor-pointer hover:bg-gray-50 transition duration-150 border-b last:border-b-0 border-gray-100">
    <div className="flex items-center space-x-3">
      <div className="w-8 h-8 flex items-center justify-center rounded-md bg-gray-50">
        <IconComponent className={`h-5 w-5 ${inactiveColor || "text-gray-500"}`} />
      </div>
...
const OverviewIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13h8V3H3v10zM13 21h8V11h-8v10zM3 21h8v-6H3v6z" />
  </svg>
);
...
const ResumeIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth="1.8" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m2-3.5L14.5 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8.5z" />
  </svg>
);
...
const RoadmapIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v13a1 1 0 0 0 1 1h3V5H4a1 1 0 0 0-1 1zM8 5v14h8V5H8zM20 3v16h-3V3h3z" />
  </svg>
);

// 4: Interview / Microphone / Chat
const InterviewIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 1v11m0 0a4 4 0 01-4 4H8a4 4 0 01-4-4V8a4 4 0 014-4h8a4 4 0 014 4v3a4 4 0 01-4 4h-1a4 4 0 01-4-4zM8 21h8" />
  </svg>
);

// 5: Skills Gap / Chart / Gauge
const SkillsIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h3M21 12h-3M7.5 12a4.5 4.5 0 019 0M12 21v-3M12 3v3" />
  </svg>
);
...
const OverviewOutlet = () => {
  ...
  // Example stat values (replace with real data)
  const stats = [
    {
      icon: <ResumeIcon className="h-6 w-6 text-blue-600" />,
      value: "82%",
      title: "ATS Score",
    ...
    {
      icon: <SkillsIcon className="h-6 w-6 text-indigo-600" />,
      value: "5",
      title: "Skills Gap",
      subtitle: "Top skills to learn",
      iconBgClass: "bg-indigo-50 text-indigo-600"
    },
    {
      icon: <RoadmapIcon className="h-6 w-6 text-purple-600" />,
      value: "12",
      title: "Matched Jobs",
    ...
    {
      icon: <InterviewIcon className="h-6 w-6 text-green-600" />,
      value: "2",
  ...
  return (
    <div className="space-y-8">
      {/* Purple Banner */}
      <div className="bg-gradient-to-r from-purple-600 to-purple-500 text-white p-8 rounded-xl shadow-xl relative overflow-hidden">
        <div className="absolute right-5 top-1/2 transform -translate-y-1/2 opacity-20 text-white">
          <svg className="w-20 h-20 fill-current" viewBox="0 0 24 24">
            <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 18c-3.32-1.34-6-4.52-6-9V6.3l6-2.67 6 2.67V10c0 4.48-2.68 7.66-6 9z" />
          </svg>
        ...
        <h2 className="text-2xl font-bold mb-1">Ready to advance your career?</h2>
        <p className="text-purple-100 mb-6">Get personalized job recommendations and improve your interview skills with AI</p>
        ...
        <div className="flex space-x-4">
          ...
          <button
            onClick={() => navigate("/overview/job-match")}
            className="bg-purple-700 text-white font-semibold py-2 px-6 rounded-lg hover:bg-purple-800 transition"
          >
            Explore Jobs
          </button>
        </div>
      ...
      {/* Two column layout: Quick Actions + Career Tips */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Quick Actions */}
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">Quick Actions</h3>
          <div className="divide-y divide-gray-100">
            <button onClick={() => navigate("/overview/resume-analysis")} className="w-full text-left">
              <QuickActionItem text="Analyze Resume" IconComponent={ResumeIcon} inactiveColor="text-blue-500" />
            </button>

            <button onClick={() => navigate("/overview/interview-prep")} className="w-full text-left">
              <QuickActionItem text="Start Interview Preparation" IconComponent={InterviewIcon} inactiveColor="text-green-500" />
            </button>

            <button onClick={() => navigate("/overview/career-roadmap")} className="w-full text-left">
              <QuickActionItem text="Career Roadmap" IconComponent={RoadmapIcon} inactiveColor="text-purple-500" />
            </button>

            <button onClick={() => navigate("/overview/skills-gap")} className="w-full text-left">
              <QuickActionItem text="Skills Gap Analysis" IconComponent={SkillsIcon} inactiveColor="text-indigo-500" />
            </button>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
          <h3 className="text-xl font-semibold mb-4 text-gray-800">Career Tips</h3>
          <div className="space-y-3">
            <CareerTip tip="Keep your resume under 2 pages for better ATS scores" bgColorClass="bg-blue-50" tipColorClass="text-blue-600" />
            <CareerTip tip="Practice behavioral questions for better interview performance" bgColorClass="bg-purple-50" tipColorClass="text-purple-600" />
            <CareerTip tip="Update your skills regularly to match industry trends" bgColorClass="bg-indigo-50" tipColorClass="text-indigo-600" />
            <CareerTip tip="Schedule short practice interviews weekly to build confidence" bgColorClass="bg-green-50" tipColorClass="text-green-600" />
          </div>
        </div>
      </div>
    </div>
