...
const InterviewPrepOutlet = () => {
    ...
    return (
        <div className="min-h-screen bg-transparent relative overflow-hidden transition-colors duration-500 text-slate-200 dark-prep-scroll selection:bg-indigo-500/30">
